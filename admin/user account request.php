                         ...
                         <table class="table datatable">
                             ...
                             <tbody>
                                 <?php
                                    ...
                                    $sql = "SELECT * FROM owners WHERE admin_confirm = '0'";
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         <div class="d-grid gap-2 d-md-block">
                                             <button class="btn btn-outline-secondary viewBtn" type="button"
                                                 data-id="<?php echo $row["id"]; ?>"><i
                                                     class="bi bi-eye-fill"></i></button>
                                             <a class="btn add-btn"
                                                 href="confirmUser.php?id=<?php echo $row["id"]; ?>"><i
                                                     class="bi bi-check-circle-fill"></i></a>
                                             <a class="btn btn-outline-secondary editBtn"
                                                 href="confirmUser.php?id=<?php echo $row["id"]; ?>&confirmation=2"
                                                 type="button"><i class="bi bi-dash-circle-fill"></i></a>
                                         </div>
                                     </td>
                                 </tr>
                                 <?php
