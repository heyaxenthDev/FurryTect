     ...
     <section class="section">
         ...
         <div class="d-flex align-items-start">
             <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                 <button class="nav-link active px-5" id="v-pills-dogs-tab" data-bs-toggle="pill" data-bs-target="#v-pills-dogs" type="button" role="tab" aria-controls="v-pills-dogs" aria-selected="true">Dogs</button>
                 <button class="nav-link px-5" id="v-pills-cats-tab" data-bs-toggle="pill" data-bs-target="#v-pills-cats" type="button" role="tab" aria-controls="v-pills-cats" aria-selected="false">Cats</button>
             </div>
             <div class="card">
                 <div class="card-body m-3 tab-content" id="v-pills-tabContent">
                     <div class="tab-pane fade show active" id="v-pills-dogs" role="tabpanel" aria-labelledby="v-pills-dogs-tab">
                         <form action="code.php" method="POST" enctype="multipart/form-data">
                             ...
                             <div class="row g-3">
                                 <div class="col-md-4">
                                     ...
                                     <input type="file" class="form-control" id="dogImageInput" name="dogImage" accept="image/*">
                                 </div>
                                 <div class="col-md-8">
                                     <div class="row mb-3 g-2">
                                         ...
                                         <div class="col-md-6" id="tagNumberDiv" style="display: none;">
                                             <div class="form-floating">
                                                 <input type="text" class="form-control" id="floatingTagNumber" placeholder="Tag Number" name="tagNumber">
                                                 <label for="floatingTagNumber">Tag Number</label>
                                             </div>
                                         </div>
                                         <div class="col-md-6" id="dateTaggedDiv" style="display: none;">
                                             <div class="form-floating">
                                                 <input type="date" class="form-control" id="floatingDateTagged" placeholder="DateTagged" name="dateTagged">
                                     ...
                                     <div class="row mb-3 g-2">
                                         ...
                                         <div class="col-md-6">
                                             <div class="form-floating">
                                                 <input type="number" class="form-control" id="floatingAge" placeholder="Age" name="age">
                                     ...
                                     <div class="row mb-3 g-2">
                                         <div class="col-md-12">
                                             <div class="form-floating">
                                                 <input type="text" class="form-control" id="floatingColor" placeholder="Color" name="color">
                                     ...
                                     <div class="row mb-3 g-2">
                                         <div class="col-md-6">
                                             <div class="form-floating">
                                                 <select class="form-control" id="floatingVaccinationStatus" aria-label="Vaccination Status" name="vaccinationStatus">
                                         ...
                                         <div class="col-md-6" id="dateVaccDiv" style="display: none;">
                                             <div class="form-floating">
                                                 <input type="date" class="form-control" id="floatingDateVacc" placeholder="Date Vaccinated" name="dateVacc">
                             ...
                             <div class="row g-3">
                                 <div class="col-md-4">
                                     <img src="assets/img/user.png" id="ownerImage" class="img-fluid rounded float-start img-thumbnail mb-3" alt="Owner Image">
                                     <input type="file" class="form-control" id="ownerImageInput" name="ownerImage" accept="image/*">
                                 </div>
                                 <div class="col-md-8">
                                     <div class="row mb-3 g-2">
                                         <div class="col-md-4">
                                         ...
                                         <div class="col-md-4">
                                             <div class="form-floating">
                                                 <input type="text" class="form-control" id="floatingMiddleName" placeholder="Middle Name" name="middleName">
                                     ...
                                     <div class="row mb-3 g-2">
                                         <div class="col-md-6">
                                             <div class="form-floating">
                                                 <select class="form-select" id="floatingOwnerSex" name="sexOwner" aria-label="Sex">
                                                     <option selected disabled>Choose...</option>
                                                     <option value="1">Male</option>
                                                     <option value="2">Female</option>
                                                 </select>
                                         ...
                                         <div class="col-md-6">
                                             <div class="form-floating">
                                                 <input type="number" class="form-control" id="floatingOwnerAge" placeholder="Age" name="ageOwner">
                                     ...
                                     <div class="row mb-3 g-2">
                                         <div class="col-md-6">
                                             <div class="form-floating">
                                                 <input type="text" class="form-control" id="floatingContactNumber" placeholder="Contact Number" name="contactNumber">
                             ...
                             <div class="d-grid gap-2 col-6 mx-auto mt-4">
                                 <button class="btn add-btn" type="submit" name="DogsReg"><i class="bi bi-check-circle"></i>
                                     Submit</button>
                     ...
                     <div class="tab-pane fade" id="v-pills-cats" role="tabpanel" aria-labelledby="v-pills-cats-tab">
                         <form action="code.php" method="POST" enctype="multipart/form-data">
                             ...
                             <div class="row g-3">
                                 <div class="col-md-4">
                                     <img src="assets/img/user.png" id="catOwnerImage" class="img-fluid rounded float-start img-thumbnail mb-3" alt="Owner Image">
                                     <input type="file" class="form-control" id="catOwnerImageInput" name="catOwnerImage" accept="image/*">
                                 </div>
                                 <div class="col-md-8">
                                     <div class="row mb-3 g-2">
                                         <div class="col-md-4">
                                     ...
                                     <div class="row mb-3 g-2">
                                         <div class="col-md-6">
                                             <div class="form-floating">
                                                 <select class="form-select" id="floatingOwnerSex" aria-label="Sex" name="sexOwner">
                                                     <option selected disabled>Choose...</option>
                                                     <option value="1">Male</option>
                                                     <option value="2">Female</option>
                                                 </select>
