...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['insertIncidentReport'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO incidentreports (incident_type, date_time, location, description, agree_terms) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssi", $incidentType, $dateTime, $location, $description, $agreeTerms);
